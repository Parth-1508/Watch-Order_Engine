...
val MIGRATION_12_13 = object : Migration(12, 13) {
    override fun migrate(db: SupportSQLiteDatabase) {
        db.execSQL(
            "ALTER TABLE media ADD COLUMN inWatchlist INTEGER NOT NULL DEFAULT 0"
        )
    }
}
...
val MIGRATION_13_14 = object : Migration(13, 14) {
    override fun migrate(db: SupportSQLiteDatabase) {
        db.execSQL(
            "ALTER TABLE user_reviews ADD COLUMN emojiReaction TEXT NOT NULL DEFAULT '🤩'"
        )
    }
}
...
val MIGRATION_17_18 = object : Migration(17, 18) {
    override fun migrate(db: SupportSQLiteDatabase) {
        db.execSQL("ALTER TABLE media ADD COLUMN imdbRating REAL")
        db.execSQL("ALTER TABLE media ADD COLUMN rottenTomatoesScore TEXT")
        db.execSQL("ALTER TABLE media ADD COLUMN metascore INTEGER")
        db.execSQL("ALTER TABLE media ADD COLUMN awardsSummary TEXT")
        db.execSQL("ALTER TABLE media ADD COLUMN networkName TEXT")
    }
}
